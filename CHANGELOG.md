...
```diff
[features]
+ GitHub-ready repository docs
+ Remote Kojo example templates
+ Correct package entrypoint in init.luau
+ Compatibility docs for drop-in Obsidian-style repo replacement
```
